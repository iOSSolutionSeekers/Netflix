...
class HomeViewController: UIViewController {
    ...
    let sectionTitles = ["Trending Movies" ,"Trending TV", "Popular Movies", "Upcoming Movies", "Top Rated"]
    
    private let HomepageTable: UITableView = {
    ...
    override func viewDidLoad() {
        ...
        HomepageTable.tableHeaderView = headerView
        configureNavBar()
    ...
    override func viewDidLayoutSubviews() {
        ...
        HomepageTable.frame = view.bounds
    }
